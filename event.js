...
function Event(opts){
	...
	function on(key, call){
		...
		/** if the event has been triggered before created, the trigger it now */
		if(preTrigger[key]) call.apply(window, preTrigger[key]);
	}
	 ...
	 * @param {*} params Params to pass to the callback
	 */
